...
RSpec.describe CalendarRecord, type: :model do
  describe 'validations' do
    ...
    let!(:calendar_record_data1) { {start_time: start_time, end_time: end_time}}
    let!(:calendar_record_data2) { {start_time: start_time, end_time: 20.days.after}}
    let!(:calendar_record_data3) { {start_time: 20.days.ago, end_time: end_time}}
    ...
    it 'cant add when time is same' do
      same = described_class.new(start_time: end_time, end_time: end_time)
